...
import importlib
MODULE_NAMES = ('STDEFS','STBINFO','STSAMPLE','STPRE','STPRE1','STPRE2','STPRE3','STFINITE','STZLIST','STPAGE','STEXPER','STMDICE','STQUIZ5','STVENN','STQUIZ4','STQUIZ3','STQUIZ','STAT1','STCORE','STDESC','STPROB','STDICE','STBINOM','STCOUNT',
